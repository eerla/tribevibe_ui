              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Date: ${event.date}', style: TextStyle(color: AppColors.accent)),
                    Text('Time: ${event.time}', style: TextStyle(color: AppColors.accent)),
                    const SizedBox(height: 12),
                    Text('Location: ${event.location}', style: TextStyle(color: AppColors.accent)),
                    const SizedBox(height: 12),
                    if (event.organizer != null && event.organizer!['name'] != null)
                      Text('Organizer: ${event.organizer!['name']}', style: TextStyle(color: AppColors.accent)),
                    if (event.createdAt != null)
                      Text('Created: ${event.createdAt}', style: TextStyle(color: AppColors.accent, fontSize: 12)),
